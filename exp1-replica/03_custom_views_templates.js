  ...
  const view = {
    ...
    //  text: config.text,
      render: function(CT, babe) {
          ...
          <section class="babe-text-container">
            <p class="babe-view-text"> Thank you for taking part in our study. We are studying how people talk about things around them. The study will take about 9-11 minutes.<br /> <br />
