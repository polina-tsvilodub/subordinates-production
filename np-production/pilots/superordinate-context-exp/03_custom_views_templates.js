...
const custom_textfield_warmup = function(config, startingTime) {
  const view = {
    ...
    <div style="width:100%;">
     <div style="width:50%;height:350px;float:left;position:relative;align:center;">
    ...
    <div style="width:50%;height:350px;float:right; position:relative;align:center;">
  ...
  const view = {
    ...
    //  text: config.text,
      render: function(CT, babe) {
          ...
          <section class="babe-text-container">
            <p class="babe-view-text"> Thank you for taking part in our study. We are studying how people talk about things around them. The study will take about 3-4 minutes.<br /> <br />
