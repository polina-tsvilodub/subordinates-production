...
const trials = _.shuffle([ {x: warmupTrials.dogs, y:mainTrials.dogs[size()][size()]},
  {x:warmupTrials.birds, y:mainTrials.birds[size()][size()]}, {x:warmupTrials.monkeys,y:mainTrials.monkeys[size()][size()]},
  {x:warmupTrials.flowers, y:mainTrials.flowers[size()][size()]}, {x:warmupTrials.fish,y:mainTrials.fish[size()][size()]},
  {x:warmupTrials.trees, y: mainTrials.trees[size()][size()]}])
